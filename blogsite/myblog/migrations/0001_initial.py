# Generated by Django 5.0.6 on 2024-06-17 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(limit_choices_to={'user_type': 'author'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField()),
                ('author', models.ForeignKey(limit_choices_to={'user_type': 'reader'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
